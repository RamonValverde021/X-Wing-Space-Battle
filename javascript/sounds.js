...
const audioTrilhaSonoraEstrelaDaMorte = new Audio('../audios/deathstar_suite.MP3');  // Audio da trilha sonora do boss Estrela da Morte
...
function somAcelerandoXWing() {
    audioAcelerandoXWing.volume = 0.5;
